...
import { LightboxEditForm } from './LightboxEditForm';
      ...
      <FocusLock returnFocus>
        ...
        >
          ...
          <div className="relative flex min-h-0 flex-1 items-center justify-center">
            ...
            {/* Edit panel — isolated in its own component so keystrokes
                don't re-render the entire lightbox (image, nav buttons, etc.) */}
            {editMode && isOwner && (
              <LightboxEditForm
                key={photo.id}
                photo={photo}
